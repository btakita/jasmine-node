...
jasmine.executeSpecs = function(path, done, isVerbose, showColors){
  var log = [];
  var columnCounter = 0;
  var start = 0;
  var elapsed = 0;
  ...
  var specs = jasmine.getAllSpecFiles(path)
...
jasmine.executeSpecsInFolder = jasmine.executeSpecs

jasmine.getAllSpecFiles = function(path, callback){
  var specs = [];
